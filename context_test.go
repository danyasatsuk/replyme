...
func TestContent_Print(t *testing.T) {
	...
	context.emitLog = func(msg logMsg) {
		if msg.Status == logMsgStatusPrint &&
			msg.Content == "test" {
			ok = true
		}
	}
...
func TestContent_Printf(t *testing.T) {
	...
	context := create()
	context.emitLog = func(msg logMsg) {
		if msg.Status == logMsgStatusPrintf &&
...
func TestContent_PrintMarkdown(t *testing.T) {
	...
	context := create()
	context.emitLog = func(msg logMsg) {
		if msg.Status == logMsgStatusPrintMarkdown &&
...
func TestContent_Warn(t *testing.T) {
	...
	context := create()
	context.emitLog = func(msg logMsg) {
		if msg.Status == logMsgStatusWarn &&
			msg.Content == "t" {
			ok = true
		}
	}
...
func TestContent_Warnf(t *testing.T) {
	...
	context := create()
	context.emitLog = func(msg logMsg) {
		if msg.Status == logMsgStatusWarnf &&
			msg.Content == "t" && msg.Data[0] == "test" {
			ok = true
		}
	}
...
func TestContent_Error(t *testing.T) {
	...
	context := create()
	context.emitLog = func(msg logMsg) {
		if msg.Status == logMsgStatusError &&
			msg.Content == "t" {
			ok = true
		}
	}
...
func TestContent_Errorf(t *testing.T) {
	...
	context := create()
	context.emitLog = func(msg logMsg) {
		if msg.Status == logMsgStatusErrorf &&
			msg.Content == "t" && msg.Data[0] == "test" {
			ok = true
		}
	}
