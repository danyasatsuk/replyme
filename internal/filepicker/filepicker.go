// This code is taken from the repository https://github.com/charmbracelet/bubbles
// Original project license: MIT
// The code has been modified to meet the requirements of the current project.
